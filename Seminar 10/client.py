...
class FTPClient:
    ...
    def rename_file(self):
        ...
        old_name = input("Enter current filename on server: ").strip()
    ...
    def download(self):
        ...
        print("\n📥 DOWNLOAD FILE")
        filename = input("Enter filename to download from server: ").strip()
    ...
    def see_file_operation_history(self):
        ...
        filename = input("Enter filename to check history: ").strip()
